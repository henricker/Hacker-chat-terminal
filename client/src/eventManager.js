...
export default class EventManager {
  ...
  joinRoomAndWaitForMessages (data) {
    this.socketClient
      .sendMessage(constants.events.socket.JOIN_ROOM, data);
  ...
  getEvents () {
    ...
    //get all functions of the class EventManager
    //and convert to type Map
    const functions = Reflect
      .ownKeys(EventManager.prototype)
